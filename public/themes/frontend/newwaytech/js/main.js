  ...
  s("#preloader").fadeOut("normall", function () {
    ...
    i.on("scroll", function () {
      ...
      e <= 50
        ...
        t.attr("src", "/img/logos/logo_header.jpg"),
        a.attr("src", "/img/logos/logo_header.jpg");
    }),
    i.on("scroll", function () {
    ...
    s(".vision-wrapper").on("mouseenter", function (e) {
      ...
      s(".vision-changebg").animate({ opacity: 0.9 }, 50, function () {
        s(".vision-changebg").css("background-image", "url(" + o + ")");
      }),
        s(".vision-changebg").delay(50).animate({ opacity: 0.9 }, 50);
    }),
