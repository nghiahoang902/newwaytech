...
!(function (o) {
  ...
  jQuery(document).ready(function (r) {
    ...
    function p(t) {
      ...
      t.parents(".banner-headline").hasClass("type")
        ...
        ? ((i = t.children("i").length >= o.children("i").length),
          (function t(e, i, o, s) {
    ...
    function f(t, e) {
      t.parents(".banner-headline").hasClass("type")
        ...
        : t.parents(".banner-headline").hasClass("clip") &&
          t
            .parents(".banner-words-wrapper")
            .animate({ width: t.width() + 10 }, u, function () {
              setTimeout(function () {
                p(t);
              }, o);
            });
      ...
      (function (t) {
        ...
        t.each(function () {
          ...
          o.hasClass("loading-bar")
            ? ((s = n),
              setTimeout(function () {
                o.find(".banner-words-wrapper").addClass("is-loading");
              }, l))
            : o.hasClass("clip")
            ? ((e = (t = o.find(".banner-words-wrapper")).width() + 10),
              t.css("width", e))
            : o.hasClass("type") ||
              ((e = o.find(".banner-words-wrapper b")),
              (i = 0),
              e.each(function () {
                var t = r(this).width();
                i < t && (i = t);
              }),
              o.find(".banner-words-wrapper").css("width", i)),
            setTimeout(function () {
        ...
        f(this).on("bind", "tabactivate", function (t, e) {
          ...
          this.each(function () {
            ...
            o
              ...
              1 == h && o.css({ width: "100%", margin: "0px" }),
              "accordion" == c &&
            ...
            var r,
              a = 0;
            "" == u ||
              (null !== (r = u.match(new RegExp(s + "([0-9]+)"))) &&
                2 === r.length &&
  ...
  (function (l, i, o, a) {
    ...
    (c.Defaults = {
        ...
        },
        {
          ...
          run: function () {
            var t = [],
              ...
              n = i.loop && e.length ? (i.rewind ? o : Math.max(o, s)) : 0,
              r = "",
              a = "";
            for (n /= 2; 0 < n; )
      ...
      (c.prototype.trigger = function (t, e, i, o, s) {
              ...
              if (
                ...
                for (
                  ...
                  this.load(n / 2 + this._core.relative(s)),
                    n && a.each(this._core.clones(this._core.relative(s)), r),
                    s++;
              }
            }, this),
        }),
    ...
    (i.Defaults = {
      ...
      (i.prototype.play = function (t, e) {
        ...
        this._core.is("rotating") || this._core.enter("rotating"),
          ...
          (this._timeout = t),
          (this._call = s.setTimeout(o.proxy(this._next, this, e), t - i));
      }),
      (i.prototype.stop = function () {
        this._core.is("rotating") &&
          ((this._time = 0),
  ...
  (function (o, s) {
    ...
    (e.Defaults = { URLhashListener: !1 }),
      (e.prototype.destroy = function () {
        var t, e;
        for (t in (o(s).off("hashchange.owl.navigation"), this._handlers))
          this._core.$element.off(t, this._handlers[t]);
        for (e in Object.getOwnPropertyNames(this))
          "function" != typeof this[e] && (this[e] = null);
      }),
        ...
        l.waypoint(
          function () {
            for (
              ...
              if ((s && (a = parseFloat((i / e) * r).toFixed(n)), o))
          ...
          (this._setPosition =
            ...
            function (t, e, i, o, s) {
              n.options.horizontalScrolling && r.setLeft(t, e, i),
                n.options.verticalScrolling && r.setTop(t, o, s);
            });
      },
        ...
        (t = {
          ...
          for (n in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              (h = !a && !c),
              !u && a && c
                ? (l.queueTrigger(r.backward), (s[l.group.id] = l.group))
      ...
      (e.prototype.flushTriggers = function () {
        for (var t in this.triggerQueues) {
          ...
          for (var o = 0, s = e.length; o < s; o += 1) {
            var n = e[o];
            (!n.options.continuous && o !== e.length - 1) || n.trigger([t]);
          }
        }
        this.clearTriggerQueues();
      }),
  ...
  (function (t) {
    ...
    function d(t, e, i, o) {
      ...
      return (
        (s.className = "mfp-" + t),
        i && (s.innerHTML = i),
        o ? e && e.appendChild(s) : ((s = c(s)), e && s.appendTo(e)),
        s
      );
    }
    function u(t, e) {
    ...
    (t.prototype = {
      ...
      (c.fn.magnificPopup = function (t) {
        ...
        return (
          "string" == typeof t
            ? "open" === t
              ? ((e = a ? s.data("magnificPopup") : s[0].magnificPopup),
                (i = parseInt(arguments[1], 10) || 0),
                (o = e.items
                  ? e.items[i]
                  : ((o = s), e.delegate && (o = o.find(e.delegate)), o.eq(i))),
          ...
          if ((C(), t.src)) {
            ...
            return (
              s.length
                ? ((i = s[0].parentNode) &&
                    i.tagName &&
                    (T || (($ = o.hiddenClass), (T = d($)), ($ = "mfp-" + $)),
                    (S = s.after(T).detach().removeClass($))),
                  f.updateStatus("ready"))
                : (f.updateStatus("error", o.tNotFound), (s = c("<div>"))),
              (t.inlineElement = s)
            );
          }
        ...
        getImage: function (t, e) {
          ...
          return (
            a.length &&
              ...
              (t.img = c(i).on("load.mfploader", s).on("error.mfploader", n)),
              (i.src = t.src),
        ...
        (e.prototype.loadContent = function (e, t, i) {
          ...
          if (!c.$slide.eq(e).hasClass("lg-loaded")) {
            if (
              ...
              u && o.attr("sizes", u),
              n && (o.attr("srcset", n), this.s.supportLegacyBrowser))
            )
              try {
        ...
        (e.prototype.enableDrag = function () {
          ...
          e.s.enableDrag &&
            ...
            f(window).on("mouseup.lg", function (t) {
              n
                ? ((n = !1), e.touchEnd(o - i), e.$el.trigger("onDragend.lg"))
        ...
        (t.prototype.build = function () {
          ...
          if (
            ...
            for (var i = 0; i < s.core.s.dynamicEl.length; i++)
              e(s.core.s.dynamicEl[i].src, s.core.s.dynamicEl[i].thumb, i);
          else
          ...
          s.core.$outer.find(".lg-thumb").html(n),
            (t = s.core.$outer.find(".lg-thumb-item")).each(function () {
              var e = a(this),
          ...
          e.core.$outer.find(".lg-thumb").on("touchstart.lg", function (t) {
            ...
            e.core.$outer.find(".lg-thumb").on("touchmove.lg", function (t) {
              e.thumbTotalWidth > e.thumbOuterWidth &&
                ...
                e.$thumbOuter.addClass("lg-dragging"),
                (n = e.left),
                (n -= o - i) > e.thumbTotalWidth - e.thumbOuterWidth &&
          ...
          function (t, e, i, o) {
            ...
            if (
              ...
              if (s.core.s.videojs)
                try {
                  videojs(
                    s.core.$slide.eq(e).find(".lg-html5").get(0),
                ...
                !s.videoLoaded &&
                  s.core.s.autoplayFirstVideo &&
                  s.core.$slide.eq(e).find(".lg-html5").get(0).play();
          }.bind(this)
        ),
          o.core.$el.on(
      ...
      (t.prototype.init = function () {
        ...
        function o(t, e, i, o) {
          var s = e.prop("offsetWidth"),
            e = n.core.s.dynamic
              ? n.core.s.dynamicEl[i].width || e[0].naturalWidth || s
        ...
        (t.prototype.zoomSwipe = function () {
          ...
          s.core.$slide.on("touchstart.lg", function (t) {
            ...
            s.core.$outer.hasClass("lg-zoomed") &&
              ...
              (o = s.core.$slide.eq(s.core.index).find(".lg-img-rotate")[0]),
              (h = s.getCurrentRotation(o)),
              (e = s.getDragAllowedAxises(e, Math.abs(h))),
              (c = e.allowY),
              ((l = e.allowX) || c) &&
                (t.preventDefault(), (n = s.getSwipeCords(t, Math.abs(h)))));
          }),
            s.core.$slide.on("touchmove.lg", function (t) {
              var e, i;
              s.core.$outer.hasClass("lg-zoomed") &&
                ((e = s.core.$slide.eq(s.core.index).find(".lg-img-wrap")),
                t.preventDefault(),
                (a = !0),
                (r = s.getSwipeCords(t, Math.abs(h))),
                s.core.$outer.addClass("lg-zoom-dragging"),
                (i = c
                  ? -Math.abs(e.attr("data-y")) +
                    (r.y - n.y) * s.getModifier(h, "Y", o)
                  : -Math.abs(e.attr("data-y"))),
                (t = l
                  ? -Math.abs(e.attr("data-x")) +
                    (r.x - n.x) * s.getModifier(h, "X", o)
                  : -Math.abs(e.attr("data-x"))),
        ...
        (t.prototype.touchendZoom = function (t, e, i, o, s) {
          ...
          (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
            (o &&
              (l <= -s.maxY ? (l = -s.maxY) : l >= -s.minY && (l = -s.minY)),
            i && (c <= -s.maxX ? (c = -s.maxX) : c >= -s.minX && (c = -s.minX)),
            o
  ...
  (function (t) {
    ...
    function e(t) {
      ...
      if (
        ...
        1 === i.deltaMode
          ? ((s *= e = h.data(this, "mousewheel-line-height")),
            (r *= e),
            (n *= e))
          : 2 === i.deltaMode &&
            ((s *= e = h.data(this, "mousewheel-page-height")),
            (r *= e),
            (n *= e));
        ...
        (h.fn[l] = function (t) {
          ...
          return (
            ...
            (t = this).each(function (t, e) {
              ...
              i
                ? (e = i[o]) && "_" != o.charAt(0)
                  ? ((i = e.apply(i, s)), (n = void 0 === n ? i : n))
                  : u(r + " is not a valid method")
                : u(l + " not initialized. Cannot call methods, i.e. " + r);
            }),
            void 0 !== n ? n : t
          );
        }),
    ...
    function g(t) {
      if (
        (b ||
          ...
          (h = f(u)),
          (g.isBoxSizeOuter = m = 200 == p(h.width)),
          d.removeChild(u)),
    ...
    (s._create = function () {
      ...
      (s._filter = function (t) {
        for (
          ...
          l.isIgnored ||
            ((a = n(l)) && i.push(l),
            a && l.isHidden ? o.push(l) : a || l.isHidden || s.push(l));
        }
    ...
    var c = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      E = {
        ...
        util: {
          encode: function (t) {
            return t instanceof I
              ? new I(t.type, E.util.encode(t.content), t.alias)
              : Array.isArray(t)
              ? t.map(E.util.encode)
              : t
                  .replace(/&/g, "&amp;")
          ...
          clone: function i(t, o) {
            ...
            switch (((o = o || {}), n)) {
              case "Object":
                ...
                for (var r in ((s = {}), (o[e] = s), t))
                  t.hasOwnProperty(r) && (s[r] = i(t[r], o));
                return s;
              case "Array":
                return (
                  (e = E.util.objId(t)),
          ...
          DFS: function t(e, i, o, s) {
            ...
            for (n in e)
              e.hasOwnProperty(n) &&
                (i.call(e, n, e[n], o || n),
                (r = e[n]),
                "Object" !== (a = E.util.type(r)) || s[l(r)]
                  ? "Array" !== a || s[l(r)] || ((s[l(r)] = !0), t(r, i, n, s))
                  : ((s[l(r)] = !0), t(r, i, null, s)));
          },
        },
        plugins: {},
        ...
        highlightAllUnder: function (t, e, i) {
          ...
          for (
            var s, n = o.elements || t.querySelectorAll(o.selector), r = 0;
            (s = n[r++]);

          )
            E.highlightElement(s, !0 === e, o.callback);
        },
        highlightElement: function (t, e, i) {
          for (var o, s = "none", n = t; n && !c.test(n.className); )
            n = n.parentNode;
          n &&
            ((s = (n.className.match(c) || [, "none"])[1].toLowerCase()),
            (o = E.languages[s])),
            (t.className =
          ...
          var a = { element: t, language: s, grammar: o, code: t.textContent };
        ...
        highlight: function (t, e, i) {
          ...
          return (
            ...
            I.stringify(E.util.encode(i.tokens), i.language)
          );
        },
        matchGrammar: function (t, e, i, o, s, n, r) {
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              ...
              for (
                ...
                f &&
                  ...
                  (d = d.pattern || d);
                for (var y = o, v = s; y < e.length; v += e[y].length, ++y) {
                  var b = e[y];
                  ...
                  if (!(b instanceof I)) {
                    if (f && y != e.length - 1) {
                      ...
                      for (
                        var w = T.index + (p ? T[1].length : 0),
                          ...
                          C = v,
                          $ = e.length;
                        x < $ && (C < _ || (!e[x].type && !e[x - 1].greedy));
                        ++x
                      )
                        (C += e[x].length) <= w && (++y, (v = C));
                    ...
                    if (T) {
                      p && (g = T[1] ? T[1].length : 0),
                        (_ = (w = T.index + g) + (T = T[0].slice(g)).length);
                      var z = b.slice(0, w),
                        k = b.slice(_),
                        b = [y, S];
                      z && (++y, (v += z.length), b.push(z));
                      z = new I(a, u ? E.tokenize(T, u) : T, m, T, f);
                      if (
                        (b.push(z),
                        k && b.push(k),
                        Array.prototype.splice.apply(e, b),
                        1 != S && E.matchGrammar(t, e, i, y, v, !0, a),
                        n)
                      )
                        break;
                    } else if (n) break;
        ...
        hooks: {
          ...
          run: function (t, e) {
            var i = E.hooks.all[t];
            if (i && i.length) for (var o, s = 0; (o = i[s++]); ) o(e);
          },
        },
        Token: I,
      };
              ...
              off: function (t, e) {
                ...
                if (o && e)
                  for (var n = 0, r = o.length; n < r; n++)
                    o[n].fn !== e && o[n].fn._ !== e && s.push(o[n]);
