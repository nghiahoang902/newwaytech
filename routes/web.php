...
Route::namespace('FrontEnd')->group(function () {
  ...
  Route::get('/register', 'UsersController@index')->name('frontend.register');
  Route::post('/register', 'UsersController@register')->name('frontend.register.post');


  Route::get('/', 'HomeController@index')->name('frontend.home');
  Route::get('search', 'CmsController@search')->name('frontend.search.index');

  Route::get('/gioi-thieu', 'CmsController@intro')->name('frontend.intro.index');

  //thiet-bi
  Route::get('/thiet-bi/{alias}', 'CmsController@device')->name('frontend.device.index');
  Route::get('/chi-tiet/{alias}', 'CmsController@detail')->name('frontend.detail.index');

  //phan-mem
  Route::get('/phan-mem/{alias}', 'CmsController@software')->name('frontend.software.index');

  //giai-phap
  Route::get('/giai-phap/{alias}', 'CmsController@software')->name('frontend.software.index');

  //lien-he
  Route::get('/lien-he', 'CmsController@contact')->name('frontend.contact.index');
  Route::post('/lien-he/send', 'CmsController@sendEmail')->name('frontend.sendEmail.index');
  ...
  //Coupons
  Route::get('coupons', 'CouponController@index')->name('frontend.coupons');
  Route::get('checkcoupon', 'CouponController@checkCoupon')->name('frontend.coupons.apply');
  // Order
