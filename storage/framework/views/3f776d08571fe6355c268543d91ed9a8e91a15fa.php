               ...
               <div class="large-12 col">
                                    ...
                                    <div class="cart-wrapper sm-touch-scroll">
                                       <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
                                          ...
                                          <tbody>
                                             ...
                                             <?php
                                                //Số tiền tạm tính
                                                $tempTotal += $details['price'] * $details['quantity'];

                                                //Tổng số tiền sau khi đã trừ voucher hoặc ko
                                             ...
                                             <tr class="woocommerce-cart-form__cart-item cart_item" data-id="<?php echo e($id); ?>">
                                                ...
                                                <td class="product-quantity" data-title="Số lượng">
                                                   <div class="quantity buttons_added">
                                                      ...
                                                      <label class="screen-reader-text"><?php echo e($details['title']); ?></label>
                                                      <input
                                                         type="number"
                                                         class="input-text qty text"
                                                         step="1"
                                                         min="1"
                                                         max="<?php echo e($details['quantityStock']); ?>"
                                                         name="quantity"
                                             ...
                                             <tr>
                                                <td colspan="3" class="actions clear">
                                                   <input type="text" name="applyCoupon" id="applyCoupon" 
                                                      ...
                                                      value="<?php echo e(isset($appliedCoupon) ? $appliedCoupon['code'] : ''); ?>"
                                                   >
                                                </td>
                                                <td colspan="3" style="padding-top: 24px;">
                                                   <button type="button"  class="button primary mt-0 pull-left small" 
                                                      onclick="checkCoupon()">Áp dụng</button>
                                                </td>
                                             </tr>
                                             <tr id="resultCoupon"> 
                                                <td colspan="3" class="actions clear" style="text-align:left; color:blue; display:none"
                                                   id="resultCoupon-success">
                                                   <div>Áp dụng mã thành công</div>
                                                </td>
                                                <td colspan="3" class="actions clear" style="text-align:left; color:red; display:none"
                                                   id="resultCoupon-fail">
                                       ...
                                       <form method="POST" action="/vnpay_payment"> 
                                          ...
                                          <table cellspacing="0" class="shop_table shop_table_responsive">
                                             <tr class="cart-subtotal">
                                                ...
                                                <td data-title="Tạm tính">
                                                   <span id="temp_amount" class="woocommerce-Price-amount amount"><?php echo e(number_format($tempTotal)); ?>

                                                      <span class="woocommerce-Price-currencySymbol">&#8363;</span>
                                                   </span>
                                                </td>
                                             </tr>
                                             <tr class="cart-subtotal" style="display:none" id="tr-coupon">
                                                <th>Voucher giảm giá</th>
                                                <td data-title="voucher">
                                                   <span class="woocommerce-Price-amount amount">
                                                      <span id="discountAmountContainer"></span>
                                                      <span class="woocommerce-Price-currencySymbol">&#8363;</span>
                                                   </span>
                                                </td>
                                             </tr>
                                             <tr class="order-total">
                                                ...
                                                <td data-title="Tổng">
                                                   <strong>
                                                      ...
                                                      <span class="woocommerce-Price-amount amount">
                                                         <span id="totalAmountContainer"><?php echo e(number_format($tempTotal)); ?></span>
                                                         <span class="woocommerce-Price-currencySymbol">&#8363;</span>
                                                      </span>
                                                   </strong> 
                                                </td>
                                          ...
                                          <div class="woocommerce-checkout-payment">
                                             ...
                                             <p class="form-row notes" id="order_comments_field" data-priority="">
                                                ...
                                                <span class="woocommerce-input-wrapper">
                                                   <textarea name="address" class="input-text " id="address" placeholder="Địa chỉ giao hàng" rows="2" cols="2" autocomplete="off" required></textarea>
                                                </span>
                                             </p>
                                             <p class="form-row notes" id="order_comments_field" data-priority="">
                  ...
                  <script type="text/javascript">
                     ...
                     function checkCoupon(){
                        var coupon = document.getElementById('applyCoupon').value;
                        var temp_amount_element = document.getElementById('temp_amount');
                        var temp_amount = temp_amount_element.textContent.trim().replace(/[^0-9]/g, '');

                        //truyền giá trị tiền tạm tính
                        var f = "?coupon=" + coupon + "&temp_amount=" + temp_amount;
                        var _url = "/checkcoupon" + f;
                        jQuery.ajax({
                           type: "GET",
                           url: _url,
                           data: f,
                           ...
                           success: function(data) {
                              if (data.success) {
                                 ...
                                 if(data.discount_amount > 0) {
                                    jQuery('#tr-coupon').css('display', 'table-row');
                                    jQuery('#discountAmountContainer').html((data.discount_amount).toLocaleString());
                                 }

                                 jQuery('#totalAmountContainer').html((data.total).toLocaleString());

                                 //lưu vào input, để sau đó lưu vào bảng tb_orders
                                 jQuery('#discount').val(data.discount_amount);
                                 jQuery('#total').val(data.total);

                                 // Hiển thị thông báo thành công
                                 jQuery('#resultCoupon-success').css('display', 'table-cell');
                                 jQuery('#resultCoupon-fail').hide();
                              } else {

                                 // Hiển thị thông báo thành lỗi
                                 jQuery('#resultCoupon-fail').css('display', 'table-cell');
                                 jQuery('#resultCoupon-success').hide();

                                 jQuery('#tr-coupon').css('display', 'none');
                                 jQuery('#totalAmountContainer').html((data.total).toLocaleString());
                              }
                           }
                        });
...
<?php /**PATH C:\xampp\htdocs\shopquanao\resources\views/frontend/pages/cart/index.blade.php ENDPATH**/ ?>