             ...
             <ul class="nav nav-left medium-nav-center nav-small  nav-divided">
                <li class="header-contact-wrapper">
                   <ul id="header-contact" class="nav nav-divided nav-uppercase header-contact">
                      ...
                      <li class="">
                         <a href="<?php echo e($web_information->information->hotline); ?>" class="tooltip" title="<?php echo e($web_information->information->hotline); ?>">
          ...
          <div class="flex-col hide-for-medium flex-right">
             ...
             <ul class="nav nav-center nav-small  nav-divided">
               <?php if(Auth::guard('web')->check()): ?>
                  <li class="">
                     <a href="#" class="tooltip" title="<?php echo e(Auth::user()->name); ?> !">
                        <i class="" style="font-size:20px;"></i>			      
                        <span>Xin chào <?php echo e(Auth::user()->name); ?> !</span>
                     </a>
                  </li>

                  <li class="">
                     <a href="<?php echo e(route('frontend.logout')); ?>" class="tooltip" title="Đăng xuất">
                        <i class="" style="font-size:20px;"></i>			      
                        <span>Đăng Xuất</span>
                     </a>
                  </li>
               ...
               <?php else: ?>
                  <li class="">
                     <a href="<?php echo e(route('frontend.login')); ?>" class="tooltip" title="Đăng nhập">
                        <i class="" style="font-size:20px;"></i>			      
                        <span>Đăng Nhập</span>
                     </a>
                  </li>
                  <li class="">
                     <a href="<?php echo e(route('frontend.register')); ?>" class="tooltip" title="Đăng ký">
                        <i class="" style="font-size:20px;"></i>			      
                        <span>Đăng Ký</span>
                     </a>
                  </li> 
