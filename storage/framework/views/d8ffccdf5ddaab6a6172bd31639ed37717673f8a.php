...
<link rel='stylesheet' id='dashicons-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/dashicons.min.css')); ?>" type='text/css' media='all' />
<link rel='stylesheet' id='menu-icons-extra-css'  href="<?php echo e(asset('themes/frontend/shopquanao/css/extra.min.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='contact-form-7-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/styles.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='bhittani_plugin_kksr-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/css.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='muahangnhanh-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/style.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='ot-vertical-menu-css-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/style121.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='related-posts-by-taxonomy-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/styles4922.css')); ?> " type='text/css' media='all' />
<style id='woocommerce-inline-inline-css' type='text/css'>
   .woocommerce form .form-row .required { visibility: visible; }
</style>
<link rel='stylesheet' id='flatsome-icons-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/fl-icons.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='flatsome-main-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/flatsome.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='flatsome-shop-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/flatsome-shop.css')); ?> " type='text/css' media='all' />
<link rel='stylesheet' id='flatsome-style-css' href="<?php echo e(asset('themes/frontend/shopquanao/css/style3.css')); ?> " type='text/css' media='all' />
<script type='text/javascript' src="<?php echo e(asset('themes/frontend/shopquanao/js/jquery.js')); ?> "></script>
<script type='text/javascript' src="<?php echo e(asset('themes/frontend/shopquanao/js/jquery-migrate.min.js')); ?> "></script>
<script type='text/javascript' src="<?php echo e(asset('themes/frontend/shopquanao/js/js.min.js')); ?> "></script>

<script type='text/javascript' src="<?php echo e(asset('themes/frontend/shopquanao/js/verification.js')); ?> "></script>
...
<?php /**PATH D:\PHPcoban\beanmobile_sapo\resources\views/frontend/panels/styles.blade.php ENDPATH**/ ?>