            ...
            <div class="row justify-content-center mt-3">
                <div class="col-lg-7 mb-2-2 mb-lg-0">
                    <div class="p-1-9 p-lg-2-2 box-shadows h-100">
                        ...
                        <?php if(isset($success)): ?>
                            <h3 class="mb-2-5 text-primary"><?php echo e($success); ?></h3>
                        <?php endif; ?>

                        <?php if($errors->any()): ?>
                            <h3 class="mb-2-5 text-primary"><?php echo e($errors->first()); ?></h3>
                        <?php endif; ?>

                        <form class="contact quform" action="<?php echo e(route('frontend.sendEmail.index')); ?>"
                ...
                <div class="col-lg-5">
                    <div class="box-shadows p-1-9 p-lg-2-2 h-100">
                        <h2 class="mb-3 text-primary text-capitalize h3"><?php echo e($web_information->information->seo_description); ?></h2>
                        <p class="mb-2-2"></p>
                        <div class="d-flex mb-4 pb-3 border-bottom border-color-extra-light-gray">
                            ...
                            <div class="flex-grow-1 ms-4">
                                ...
                                <span class="text-muted d-block mb-1"><?php echo e($web_information->information->phone); ?></span>
                            </div>
                        </div>
                        <div class="d-flex mb-4 pb-3 border-bottom border-color-extra-light-gray">
                            <div class="flex-shrink-0 mt-2">
                            ...
                            <div class="flex-grow-1 ms-4">
                                ...
                                <span class="text-muted d-block mb-1"><?php echo e($web_information->information->email); ?></span>
                            </div>
                        </div>
                        <div class="d-flex mb-4 pb-3 border-bottom border-color-extra-light-gray">
                            <div class="flex-shrink-0 mt-2">
                            ...
                            <div class="flex-grow-1 ms-4">
                                ...
                                <address class="text-muted d-block mb-0 w-md-80 w-xl-70"><?php echo e($web_information->information->address); ?></address>
                            </div>
                        </div>
                        <ul class="social-box">
                            <li>
...
<?php echo $__env->make('frontend.default.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHPcoban\beanmobile_sapo\resources\views/frontend/contact/index.blade.php ENDPATH**/ ?>