...
<?php $__env->startSection('content'); ?>
  ...
  <section class="content-header">
    <h1>
      ...
      <a class="btn btn-sm btn-warning pull-right" href="<?php echo e(route(Request::segment(2) . '.update', $images->id)); ?>"><i
  ...
  <section class="content">
    ...
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
      <!-- form start -->
      <form role="form" action="<?php echo e(route(Request::segment(2) . '.update', $images->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="title" value="<?php echo e($images->title); ?>">
                    </div>
                    <div class="form-group">
                      ...
                      <textarea name="description" id="mota" maxlength="255" onkeyup="demKytu('description','remainingInput_textarea');" 
                        ...
                        class="form-control" rows="5"><?php echo e($images->description); ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <img src="<?php echo e($images->image); ?>" alt="" width="90px">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopquanao\resources\views/admin/pages/cms_images/edit.blade.php ENDPATH**/ ?>