          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th><?php echo app('translator')->get('Điện thoại'); ?></th>
                <th><?php echo app('translator')->get('Tổng số lượng'); ?></th>
                <th><?php echo app('translator')->get('Tổng tiền'); ?></th>
                <th><?php echo app('translator')->get('Số tiền được giảm'); ?></th>
                <th><?php echo app('translator')->get('Ghi chú'); ?></th>
                <th><?php echo app('translator')->get('Admin ghi chú'); ?></th>
                <th><?php echo app('translator')->get('Thời gian tạo'); ?></th>
              ...
              <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                  ...
                  <tr class="valign-middle">
                    ...
                    <td>
                      <?php echo e(isset($row->created_at) ? \Carbon\Carbon::parse($row->created_at)->format('d/m/Y H:i:s') : ''); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopquanao\resources\views/admin/pages/orders/order_product_list.blade.php ENDPATH**/ ?>