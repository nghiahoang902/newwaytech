                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <td>
                        Giá sản phẩm: <?php echo e(number_format($row->gia) ?? ''); ?> <br/>
                        Giá khuyến mãi: <?php echo e(number_format($row->giakm) ?? ''); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopquanao\resources\views/admin/pages/cms_products/index.blade.php ENDPATH**/ ?>