      ...
      <div class="box-body">
        <div class="col-md-6">
          ...
          <div class="form-group">
            <label><?php echo app('translator')->get('option_name'); ?> <small class="text-red">*</small>: <small><i>Viết theo cấu trúc dạng tên biến (snake_case, SNAKE_CASE hoặc camelCase)</i></small></label>
            <input type="text" class="form-control" name="option_name" placeholder="<?php echo app('translator')->get('option_name'); ?>"
              value="<?php echo e(old('option_name')); ?>" required>
          </div>

          <div class="form-group">
            <label><?php echo app('translator')->get('option_value'); ?> <small class="text-red">*</small>: <small><i>Có thể là dạng dữ liệu có cấu trúc (json, array,...)</i></small></label>
            <textarea name="option_value" id="option_value" class="form-control"
              rows="5" required><?php echo e(old('option_value')); ?></textarea>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopquanao\resources\views/admin/pages/options/create.blade.php ENDPATH**/ ?>