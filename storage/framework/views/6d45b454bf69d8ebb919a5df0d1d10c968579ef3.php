                        ...
                        <div class="row">
                           ...
                           <div class="product-info summary entry-summary col col-fit product-summary form-flat">
                              ...
                              <div class="single_variation_wrap">
                                    ...
                                    <?php if($detail->soluongconlai > 0 && $detail->tinhtrang == 1): ?>
                                       <div class="quantity buttons_added">
                                          ...
                                          <input
                                             ...
                                             step="1"
                                             min="1"
                                             max="<?php echo e($detail->soluongconlai); ?>"
                                             name="quantity"
                                             value="1"
                                             title="SL"
                                             size="4"
                                 ...
                                 <?php if($detail->soluongconlai >= 0): ?>
                                    <span><?php echo e($detail->soluongconlai); ?> sản phẩm còn lại</span>
                                 <?php endif; ?>
                              </div>
                              <script type="text/javascript">
                                 function addCart(){
                                    ...
                                    quantityInput.addEventListener('input', function() {
                                       if(parseInt(quantity) > <?php echo e($detail->soluongconlai); ?>) {
                                          parseInt(quantity) = <?php echo e($detail->soluongconlai); ?>
