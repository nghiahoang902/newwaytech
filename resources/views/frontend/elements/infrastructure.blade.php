    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 mb-4 mb-lg-0">
                <div class="row g-0">
                    <div class="col-md-5 col-lg-4 bg-img cover-background min-height-300" data-background="{{ $infrastructure->image }}">
                    </div>
                    <div class="col-md-7 col-lg-8" style="box-shadow: 3px 3px 5px #ccc;">
                        <div class="box-shadow3 d-table h-100 w-100">
                            <div class="d-table-cell p-1-6 p-sm-2-2 vertical-align-middle">
                                <h3 class="h4 text-center">{{ $infrastructure->title }}</h3>
                                <p class="lead" style="margin:0px">{{ $infrastructure->brief }}</p>
                            </div>
                        </div>
                    </div>
                </div>
