                    ...
                    <div class="menu_area alt-font">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            ...
                            <div class="navbar-header navbar-header-custom">
                                <!-- start logo -->
                                <a href="{{ route('frontend.home') }}" class="navbar-brand"><img id="logo"
                                        src="{{ $web_information->image->logo_header }}" alt="logo"></a>
                                <!-- end logo -->
                            </div>
                            ...
                            <div class="attr-nav align-items-lg-center ms-lg-auto">
                                <ul>
                                    <li class="d-none d-xl-inline-block"><a href="{{ route('frontend.contact.index') }}" class="butn md"><i class="ti-arrow-right icon-arrow before"></i><span class="label">Tư vấn miễn phí</span><i class="ti-arrow-right icon-arrow after"></i></a></li>
                                </ul>
                            </div>
