        ...
        <div class="row mt-n2-6 pt-15">
            <div class="col-sm-6 col-xl-3 mt-2-6">
                <div class="footer-logo mb-1-6">
                    <img src="{{ $web_information->image->logo_footer }}" alt="...">
                </div>
                <p class="text-white mb-1-6 opacity9">{{ $web_information->information->seo_description }}</p>
                ...
                <div class="ps-sm-1-6 ps-md-2-5">
                    ...
                    <ul class="contact-list">
                        <li><span class="fas fa-map-marker-alt pe-3 text-white"></span><a
                                href="#!">{{ $web_information->information->address }}</a></li>
                        <li><span class="fa fa-phone pe-3 text-white"></span><a
                                href="#!">{{ $web_information->information->phone }}</a></li>
                        <li><span class="fas fa-globe pe-3 text-white"></span><a
                                href="#!">{{ $web_information->information->email }}</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3 mt-2-6">
                <div class="ps-sm-1-9 ps-xl-6">
                    <h3 class="h5 text-white text-capitalize mb-1-6 mb-lg-1-9"><span class="me-2">|</span>{{ $partner->brief }}</h3>
                    <div class="row g-2">
