                                ...
                                <div class="col-lg-12 mt-1-9">
                                    <article class="card card-style10">
                                        ...
                                        <div class="card-body col-lg-8">
                                            <div class="category"><span>{{ $item->created_at }}</span></div>
                                            <h3 class="h4 mb-3"><a href="{{ route('frontend.detail.index', $item->alias) }}">{{ $item->title }}</a></h3>
                                            <p class="mb-3">{{ $item->mota }}</p>
                                            <a class="link-btn" href="{{ route('frontend.detail.index', $item->alias) }}"><span class="link-text">Chi
                                                    tiết</span></a>
                                        </div>
                                    </article>
                                </div>
